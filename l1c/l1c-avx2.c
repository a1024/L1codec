			...
			}
			{
				...
				if(effort==1)//predict
				{
					...
					*/
					...
					//NE
					L1preds[3*3+0]=_mm256_load_si256((__m256i*)rows[1]+0+0+1*6);
					L1preds[3*3+1]=_mm256_load_si256((__m256i*)rows[1]+0+1+1*6);
					L1preds[3*3+2]=_mm256_load_si256((__m256i*)rows[1]+0+2+1*6);
